    ...
    <div class="row justify-content-center">
        <div class="col-xs-12 col-md-10">
            <div class="home-banner pt-4">
                <h1><span>Social Network Application</span></h1>
                <h3>A Social Network for Engineering and Technology</h3>
                ...
                @guest
                <div class="mt-5">
                    <a href="#" class="btn btn-primary btn-rounded btn-lg mb-3">Sign Up with Email</a>
                </div>
                @endguest
                <hr class="my-3">
            </div>
